...
from students where password = '12333';

--9. Вывести пользователей которые были созданы 2021-03-26 00:00:00
select name, created_on 
from students where created_on = '2021-03-26 00:00:00';
...
select name, id from students 
where id not between 27 and 88;
...
select min (id) as smalleestID from students; 

--29. Вывести максимальный id
select max (id) as larghestID from students;
